  ...
  <div class="container">
    <div class="cart_inner">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <div class="btn-group radio-group ml-2" data-toggle="buttons">
                  <button class="btn btn-sm btn-success btn-rounded tombol-tambah">+</button>
                  <button class="btn btn-sm btn-warning btn-rounded tombol-kurang">-</button>
                  <button type="button" class="btn btn-sm btn-danger tombolhapus" data-toggle="tooltip" data-placement="top" title="Remove item">x</button>
              </div>
              </td>
              <td>
                @if ($harga != 0)
        ...
        <div>
        <a style="margin-top:10px;" href="/home" class="btn btn-warning mr-2 center-block">Continue Shopping</a>
        <div>
      </div>
    </div>
  </div>
